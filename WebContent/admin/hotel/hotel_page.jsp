...
<div class="jumbotron-fluid">
	<div class="container">
		<div class="jumbotron img-jmbo">
			<h1>ADD HOTELS</h1>
			<a href="./hotel_add_page.jsp" class="nav-link custom-button1">GO</a>
		</div>
		<div class="jumbotron img-jmbo">
			<h1>UPDATE HOTELS</h1>
			<a href="./hotel_update_select_page.jsp" class="nav-link custom-button1">GO</a>
		</div>
	</div>
	<div class="container">
		<div class="jumbotron img-jmbo">
			<h1>DELETE HOTELS</h1>
			<a href="./hotel_delete_page.jsp" class="nav-link custom-button1">GO</a>
		</div>
	</div>
	</div>
</div>
