...
<html>
<head>
<title>Hotel Delete Select Page</title>
...
<section>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	    ...
	    <div class="collapse navbar-collapse" id="navbarMenu">
	        <span class="navbar-nav ml-auto" style="font-size:1.5rem; font-weight:bold; color:white">HOTEL SELECT</span>
...
<div class="container">
	<div class="jumbotron">
		<form action="/cloud9_hrb/delete_hotel" method="post">		  
		  <div class="row mb-3">
